...
const selectedMetric = ref<'employment_rate_overall' | 'gross_monthly_mean'>(
    ...
    <CardHeader>
      ...
      <div class="flex flex-col gap-4 sm:flex-row">
        <Select v-model="selectedPath" class="flex-1">
          <!-- Added aria-label to SelectTrigger due to WCAG 4.1.2 as suggested by GovTech Accessibility checker to provide discernible text for screen readers -->
          <SelectTrigger aria-label="Select course for statistics">
        ...
        <Select v-model="selectedMetric" class="w-full sm:w-[200px]">
          <!-- Added aria-label to SelectTrigger due to WCAG 4.1.2 as suggested by GovTech Accessibility checker to provide discernible text for screen readers -->
          <SelectTrigger aria-label="Select metric type for statistics">
